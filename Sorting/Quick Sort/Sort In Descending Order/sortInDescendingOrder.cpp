...
/*
In sorting an array in descending order using quick sort, the steps to follow are: 
1. Select a pivot (in my case, I am selecteing the end element as pivot). 
2. Find the correct position of pivot and ensure that all of the left side elements of pivot are greater or equal to it and all of the right side elements are smaller than it.
3. Divide the array in two arrays: 
    a. Left array containing all elements greater than pivot. 
    b. Right array containing all elements smaller than pivot.
